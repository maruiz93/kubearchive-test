...
description: Coordinate triage of a GitHub issue by orchestrating analysis subagents and applying labels
allowed-tools: comment_issue, add_label
---
...
2. Evaluate information quality and gather external context from linked resources
3. If external context was gathered, add it as a comment on the issue so it's available to anyone addressing it
4. If the issue is a bug, verify reproducibility
